                    ...
                    for head, sha_name in enumerate(sha_encoding_name_list):
                        if is_v1_aimet_encodings:
                            if activ_param_encoding == "param_encodings":
                                sliced_mha_encoding = handle_aimet_v1_param_encodings(lora_adaptor_mha_encoding, sha_name, head, head_num) if not ptq_or_activation else lora_adaptor_mha_encoding
                            else:
