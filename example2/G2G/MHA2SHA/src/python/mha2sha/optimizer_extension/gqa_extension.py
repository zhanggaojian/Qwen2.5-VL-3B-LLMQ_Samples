...
class GqaExtension:
    ...
    def get_kv_group_head_num(self, 
        ...
        matmul_input_shape = get_constant_node_value(
    ...
    def reset_and_pre_build_kv_proj_nodes(
        ...
        for head_num in range(self.kv_head_num):
            ...
            if self.mha2sha_optim.handle_rope_ops:
                ...
                key_conv = self.mha2sha_optim._rope_extension.create_llama_rope_node(key_conv, cos_node, sin_node, head_dim, BranchType.K)
    ...
    def post_process_kv_for_rope(self, info_dict, ns):
        ...
        for kv_head_num, (key_node, value_node) in enumerate(zip(self.key_groups_list, self.value_groups_list)):
            ...
            if self.mha2sha_optim.kv_cache:
                ...
                key_transpose, value_transpose = self.mha2sha_optim._past_kv_extension.concat_past_key_value_input(past_key_inp, past_value_inp, key_transpose, value_transpose, kv_head_num)
